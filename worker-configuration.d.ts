/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ee70c3f4d2e74f72c4a24e3bad8c851c)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_AUTH_MODE: "access";
	ORGANIZATION_ID: "skydeo";
	PREVIEW_HOSTNAME: "landing-mcp.skydeo.com";
	PREVIEW_TTL_SECONDS: "86400";
	PREVIEW_ACCESS_JWKS_URL: "https://rough-feather-4050.cloudflareaccess.com/cdn-cgi/access/certs";
	REPOSITORY_REMOTE_URL: "git@github.com:irwing-reza/skydeo-landings.git";
	REPOSITORY_RELEASE_REF: "refs/heads/master";
	REPOSITORY_BASE_SHA: "010829fa4235fb312e6706d0c8a050c2f8084499";
	...
	REPOSITORY_CHECKOUT_TOKEN: string;
	LANDING_MCP: DurableObjectNamespace<import("./src/index").LandingMcp>;
	DRAFTS: DurableObjectNamespace<import("./src/index").DraftCoordinator>;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LandingMcp" | "DraftCoordinator" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_AUTH_MODE" | "ORGANIZATION_ID" | "PREVIEW_HOSTNAME" | "PREVIEW_TTL_SECONDS" | "PREVIEW_ACCESS_JWKS_URL" | "REPOSITORY_REMOTE_URL" | "REPOSITORY_RELEASE_REF" | "REPOSITORY_BASE_SHA" | "ACCESS_CLIENT_ID" | "ACCESS_CLIENT_SECRET" | "ACCESS_TOKEN_URL" | "ACCESS_AUTHORIZATION_URL" | "ACCESS_JWKS_URL" | "PREVIEW_ACCESS_AUD" | "COOKIE_ENCRYPTION_KEY" | "REPOSITORY_CHECKOUT_TOKEN">> {}
}
